...
let s:p.normal.right = [ [ s:nord1, s:nord8, 'bold' ], [ s:nord1, s:nord8, 'bold' ] ]
...
let s:p.insert.right = [ [ s:nord1, s:nord6, 'bold' ], [ s:nord1, s:nord6, 'bold' ] ]

let s:p.replace.left = [ [ s:nord1, s:nord11, 'bold' ], [ s:nord5, s:nord1 ] ]
let s:p.replace.right = [ [ s:nord1, s:nord11, 'bold' ], [ s:nord1, s:nord11, 'bold' ] ]

let s:p.visual.left = [ [ s:nord1, s:nord13, 'bold' ], [ s:nord5, s:nord1 ] ]
let s:p.visual.right = [ [ s:nord1, s:nord13, 'bold' ], [ s:nord1, s:nord13, 'bold' ] ]
